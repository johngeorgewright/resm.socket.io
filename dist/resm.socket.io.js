...
Client = (function(superclass){
  ...
  prototype.create = function(data, callback){
    if (callback) {
      return dispatchBroadcastableAction(this, this.actionTypes.create, data, callback);
    } else {
      callback = data;
      return this.emitter.on(this.actionTypes.create, callback);
    }
  };
  prototype.update = function(data, callback){
    if (callback) {
      ...
      callback = data;
      return this.emitter.on(this.actionTypes.update, callback);
    }
  };
  prototype['delete'] = function(data, callback){
    if (callback) {
      ...
      callback = data;
      return this.emitter.on(this.actionTypes['delete'], callback);
    }
  };
  function Client(){
...
},{"./Messenger":2,"./Model":3}],2:[function(require,module,exports){
// Generated by LiveScript 1.3.0
